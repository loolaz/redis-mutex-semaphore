	...
	var that = this,
		...
		scheduling = function(priority, waitingObj){
			if(priority === 0){
				...
				var delay = Math.floor(Math.random()*((priority+20)-priority))+priority;
				setTimeout(function(){
					that.makeWaitingFunc(priority)(waitingObj.timeout, waitingObj.cb, waitingObj._cb, true);					
				}, delay);	
			}
...
SharedObject.prototype._convertPromiseCall = function(p, cb){
	if(cb && typeof cb === "function"){
		p.then(function(result){
			cb(null, result);
		}).catch(function(err){
...
SharedObject.prototype.reset = function(cb){
	return this._convertPromiseCall(this._reset(), cb);
};

SharedObject.prototype.get = function(cb){
	return this._convertPromiseCall(this._get(), cb);
};
...
SharedObject.prototype.rel = function(arg, cb){
	...
	return this._convertPromiseCall(this._rel(arg), cb);
};
