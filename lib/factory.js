...
exports.factory = function(connect_options, cb){
	var	mutexTimer = {},
		SharedObjectFactory = function(connect_options, cb) {
			function promisifyRedisClient(redisClient){
				...
				redisClient.pexpireAsync = Promise.promisify(redisClient.pexpireAsync);
				redisClient.expireAsync = Promise.promisify(redisClient.expireAsync);
			}			
	...
	Semaphore.prototype._rel = function(cb){
		var that = this;
	...
	Mutex.prototype._rel = function(muid, cb){
		var that = this;
